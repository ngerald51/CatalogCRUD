...
@app.route('/restaurant/<int:catalog_id>/menu/JSON')
...
@app.route('/restaurant/<int:catalog_id>/menu/<int:menu_id>/JSON')
...
def showRestaurants():
    ...
    if 'username' not in login_session:
        return render_template('publicrestaurants.html', catalogs=catalogs)
    else:
        return render_template('restaurants.html', catalogs=catalogs)
...
@app.route('/restaurant/<int:catalog_id>/edit/', methods=['GET', 'POST'])
def editRestaurant(catalog_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('editRestaurant.html', catalogs=editedCatalog)


# Delete a restaurant
@app.route('/restaurant/<int:catalog_id>/delete/', methods=['GET', 'POST'])
def deleteRestaurant(catalog_id):
    ...
    if catalogToDelete.user_id != login_session['user_id']:
        flash("You are not authorized to delete this catalog. Please create your own catalog in order to delete.")
    if request.method == 'POST':
        ...
        return render_template('deleteRestaurant.html', catalogs=catalogToDelete)
...
def showMenu(catalog_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        return render_template('publicmenu.html', items=items, catalogs=catalog, creator=creator)
    else:
        return render_template('menu.html', items=items, catalogs=catalog, creator=creator)


# Create a new menu item
@app.route('/restaurant/<int:catalog_id>/menu/new/', methods=['GET', 'POST'])
@login_required
def newMenuItem(catalog_id):
    ...
    if request.method == 'POST':
        newItem = Item(name=request.form['name'], description=request.form['description'], catalog_id=catalog_id,
...
# Edit a menu item
@app.route('/restaurant/<int:catalog_id>/menu/<int:menu_id>/edit', methods=['GET', 'POST'])
@login_required
...
# Delete a menu item
@app.route('/restaurant/<int:catalog_id>/menu/<int:menu_id>/delete', methods=['GET', 'POST'])
@login_required
